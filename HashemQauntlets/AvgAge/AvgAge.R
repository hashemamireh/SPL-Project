...
accountAge.Graph = ggplot(re, aes(reorder(Subreddit, Average.Account.Age), Average.Account.Age)) + geom_bar(stat = "identity") + xlab("Subreddit") + ylab("Average Account Age (days)") + 
